<?php
	...
	$query = "select * from Program_Members, Users, Programs where user=eagle_id and program=program_id and program_name='$program' and semester='$semester' and year='$year' order by last_name asc";			
